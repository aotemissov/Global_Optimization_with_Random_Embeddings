% The code generates Figure 5 in the paper (arxiv version) Cartis, Otemissov, 
% "A dimensionality reduction technique 
% for unconstrained global optimization of functions with low effective dimensionality"
% which compares REGO vs no embedding with DIRECT solver.
...
Results_REGO = load('Results_REGO_DIRECT.mat'); %this contains the data for REGO
Results_noemb = load('Results_no_embedding_DIRECT(vsREGO).mat'); %this contains the data for no embedding
...
% The following code generates the figure similar to Figure 5 in the paper. Note that the code
...
set(ylabh,'position',get(ylabh,'position') + [0.02 0 0],'fontsize',13);
